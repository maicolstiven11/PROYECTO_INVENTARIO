    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <link rel="stylesheet" href="${pageContext.request.contextPath}/css/visualizar_gastos.css">
            ...
            <body>
                ...
                <main>
                    ...
                    <div class="table-container">
                        <table class="data-table">
                            ...
                            <tbody class="data-table__body">
                                <%-- AQUÍ ESTÁ LA MAGIA: Iteramos sobre la lista que viene del Servlet --%>
                                    <c:choose>
                    ...
                    <a href="${pageContext.request.contextPath}/view/menu_inventario.html" class="btn-regresar">
