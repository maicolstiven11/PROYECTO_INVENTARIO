    ...
    <main>
        <div class="contenedor-perfil">
            ...
            <div class="info-perfil">
                ...
                <div class="item-info">
                    <span class="etiqueta-info">Correo Electronico:</span>
                    <span class="valor-info">${usuarioLogueado.email}</span>
                </div>
                <div class="item-info">
                    <span class="etiqueta-info">Telefono:</span>
                    <span class="valor-info">${usuarioLogueado.telefono}</span>
                </div>
            </div>
            ...
            <div class="estadisticas-perfil">
                ...
                <div class="tarjeta-estadistica">
                    <span class="numero-estadistica">${numTrabajadores}</span>
                    <span class="etiqueta-estadistica">Trabajadores</span>
                </div>
            </div>

            <a href="Menu_sistema.jsp" class="btn-regresar">
